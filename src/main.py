...
def run():
    ...
    try:
        run_account(PaymentType.CREDIT, categories)
        run_account(PaymentType.DEBIT, categories)
        run_account(PaymentType.SAVINGS, categories)
        run_account(PaymentType.PERMANENT_SAVINGS, categories)
...
def run_account(account_type, categories):
